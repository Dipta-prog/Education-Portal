...
const EditStudent = () => {
    ...
    const onSubmit = data => {
        ...
        const url = `https://education-portal-1.herokuapp.com/admin/update${id}`
        fetch(url, {
            method: 'PATCH',
            headers: {
    ...
    const [editSudentsData, setEditStudentsData] = useState([]);
        useEffect(() => {
            const url = `https://education-portal-1.herokuapp.com/admin/editStudent/${id}`
            fetch(url)
                .then(res => res.json())
                .then(data => setEditStudentsData(data.result))
        }, [id])

        console.log(editSudentsData);
                    ...
                    <div className="page-header">
                        <div className="row">
                            <div className="col-sm-12">
                                <h2 className="page-title my-3">Edit Students</h2>
                            </div>
                        </div>
                    </div>
                    <div className="">
