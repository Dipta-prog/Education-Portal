...
const listt = [
  {
    ...
    icons: (
      <div className="depOverview_icon">
        <FaUser className="depOverview_icons" /> 50
      </div>
    ),
  },
  {
    ...
    icons: (
      <div className="depOverview_icon">
        <FaDiceD20 className="depOverview_icons" /> 4yrs
      </div>
    ),
  },
  {
    ...
    icons: (
      <div className="depOverview_icon">
        <FaRegClock className="depOverview_icons" /> 125
      </div>
    ),
  },
  {
    ...
    icons: (
      <div className="depOverview_icon">
        <GiWhiteBook className="depOverview_icons" /> 12
      </div>
    ),
  },
];
